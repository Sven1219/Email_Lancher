...
public class DeleteActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getGmailDeleteMessages();
        String category = getString(R.string.delete);
        List<Email> emailList = new ArrayList<>();

        categoryText.setText(category);
        setMenuItemBackground(R.id.toDelete);
    ...
    public void getGmailDeleteMessages() {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        Gmail.Users.Messages.List request = mGmailService.users().messages().list("me");
                        request.setQ(query);
                        ...
                        runOnUiThread(() -> {
                            ...
                            Log.d("emailList",emailList.size()+"");
                        });
